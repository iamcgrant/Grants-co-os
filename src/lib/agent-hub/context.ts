...
export const CORE_BUSINESS_FACTS: {
  ...
  },
  {
    ...
    value: {
      ...
      writesEnabled: false,
      writesEnvIgnoredInPhase2: true,
      classGatedWriteFlags: [
      ...
      classGatedWriteFlagsDefault: false,
  ...
  {
    category: "RULE",
    key: "crc.phase2.class_gated_writes",
    title: "CRC Phase 2 — class-gated write scaffolding",
    value: {
      liveClients: false,
      bulkGhlCreate: false,
      autoMerge: false,
      globalWritesHonored: false,
      sequencer: ["backup", "write", "verify", "reconcile", "continue"],
      ...
      workFirst: "RECENTLY_WORKED_TRANSITION_RISK",
      dfMissingIsQueueNotAutoCreate: true,
      documentsSourceSystem: "CREDIT_REPAIR_CLOUD",
      rawFilesInGit: false,
    },
  },
  {
