...
const USER_SEND_OPS = Object.freeze(["send-text", "send-attachment", "reply", "react"]);

const AUTONOMOUS_OPS = Object.freeze([
  "permission-status",
  "recheck-permissions",
  "active-account",
  "list-conversations",
...
function isUserSendOp(op) {
  return USER_SEND_OPS.includes(String(op || ""));
}

function isAutonomousOp(op) {
  return AUTONOMOUS_OPS.includes(String(op || ""));
}
